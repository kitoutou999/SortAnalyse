...
/**
 * Fonction mathématique f(x).
 * @param {number} x - La valeur d'entrée.
 * @returns {number} - Le résultat de la fonction.
 */
function f(x) {
...
/**
 * Génère des points pour la fonction et la ligne cible.
 * @param {number} [numPoints=500] - Le nombre de points à générer.
 * @returns {Object} - Les points de la fonction et la ligne cible.
 */
...
/**
 * Trouve les solutions pour une valeur cible donnée.
 * @param {number} targetValue - La valeur cible.
 * @returns {number[]} - Les solutions trouvées.
 */
...
/**
 * Trouve la racine d'une fonction dans un intervalle donné.
 * @param {Function} func - La fonction pour laquelle trouver la racine.
 * @param {number} a - La borne inférieure de l'intervalle.
 * @param {number} b - La borne supérieure de l'intervalle.
 * @param {number} [tolerance=1e-7] - La tolérance pour la précision de la racine.
 * @returns {number|null} - La racine trouvée ou null si aucune racine n'est trouvée.
 */
...
/**
 * Met à jour le graphique avec les nouvelles solutions.
 * @param {number[]} [solutions=[]] - Les solutions à afficher sur le graphique.
 */
...
/**
 * Met à jour les informations des solutions affichées.
 * @param {number[]} solutions - Les solutions à afficher.
 */
...
/**
 * Met à jour le tableau des valeurs de la fonction.
 */
...
/**
 * Met à jour la valeur cible et les éléments associés.
 * @param {number} value - La nouvelle valeur cible.
 */
...
/**
 * Initialise les événements et les éléments de la page une fois le DOM chargé.
 */
