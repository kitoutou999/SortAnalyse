...
/**
 * Crée une carte avec des menus déroulants pour chaque ligne de la liste déroulante.
 * @param {Object} config - La configuration contenant les noms des générateurs et les comptes.
 */
...
/**
 * Restaure le nom du générateur en ajoutant "Strategy" et en supprimant l'espace avant les chiffres.
 * @param {string} name - Le nom du générateur.
 * @returns {string} - Le nom restauré.
 */
...
/**
 * Met à jour les données des menus déroulants et les graphiques associés.
 * @param {number} cardId - L'identifiant de la carte à mettre à jour.
 */
